  ...
  <section id="casas" className="py-20 gradient-hero text-white">
    <div className="container mx-auto px-4">
      <h2 className="text-clamp-h2 font-poppins font-bold text-center mb-4">
        Automação de Iluminação para Casas de Alto Padrão
      </h2>
      <div className="w-[70px] h-1 bg-accent mx-auto mb-4" />
      <p className="opacity-90 text-center max-w-2xl mx-auto mb-12">
        Soluções exclusivas de iluminação inteligente para residências de alto padrão em São Paulo. Sofisticação, tecnologia e elegância em cada ambiente.
      </p>
      ...
      <div className="text-center mt-10">
        <a
          href="https://wa.me/5511975596711?text=Gostaria de um projeto de iluminação para minha casa de alto padrão"
          rel="nofollow"
          target="_blank"
