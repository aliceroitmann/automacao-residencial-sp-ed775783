...
const testimonials = [
  {
    ...
    role: "Proprietária — Apartamento Centro, Indaiatuba",
    text: "A equipe transformou completamente a iluminação do meu apartamento em Indaiatuba. Os cenários personalizados são incríveis — o Modo Cinema e o Jantar Romântico viraram nossos favoritos. A economia na conta de luz foi de quase 50% e o controle por voz com Alexa é extremamente prático. Profissionais impecáveis do início ao fim.",
  },
  {
    initials: "CR",
    name: "Carlos Ribeiro",
    role: "Arquiteto — CR Arquitetura, Campinas",
    text: "Como arquiteto, indico a Automação Residencial em Indaiatuba para todos os meus projetos de alto padrão na região. A integração da automação de iluminação com a proposta arquitetônica é perfeita. A equipe técnica compreende a linguagem de design e esconde a tecnologia com elegância. Os resultados são sempre surpreendentes.",
  },
  {
    initials: "LS",
    name: "Luciana Santos",
    role: "Proprietária — Casa Condomínio Reserva, Indaiatuba",
  ...
  },
  {
    ...
    role: "Proprietário — Casa Jd. Mantiqueira, Itu",
  ...
  },
  {
    initials: "JC",
    name: "Juliana Costa",
    role: "Designer de Interiores — JC Design, Vinhedo",
    text: "Trabalho com essa equipe há 3 anos e em todos os projetos a entrega foi impecável. A personalização dos cenários de iluminação valoriza enormemente o projeto de interiores. A temperatura de cor ajustável e o dimmer inteligente fazem toda a diferença na ambientação que proponho aos meus clientes.",
  },
  {
    initials: "MT",
    name: "Marcos Tavares",
    role: "Proprietário — Casa Condomínio Terras de Indaiatuba",
  ...
  <section id="depoimentos" className="py-20 bg-secondary">
    <div className="container mx-auto px-4">
      ...
      <p className="text-muted-foreground text-center max-w-xl mx-auto mb-12">
        Depoimentos reais de famílias e profissionais que transformaram seus ambientes com nossa automação de iluminação em Indaiatuba e região.
      </p>
