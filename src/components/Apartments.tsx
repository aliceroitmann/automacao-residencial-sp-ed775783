...
const solutions = [
  ...
  },
  {
    ...
    text: "Projetos exclusivos de iluminação para coberturas, com integração entre áreas internas e terraços. Cenários que acompanham o pôr do sol da região de Indaiatuba.",
  },
  {
    icon: "📐",
  ...
  <section id="apartamentos" className="py-20 bg-secondary">
    <div className="container mx-auto px-4">
      <h2 className="text-clamp-h2 text-foreground text-center mb-4">
        Automação de Iluminação para Apartamentos em Indaiatuba
      </h2>
      <div className="w-[70px] h-1 bg-accent mx-auto mb-4" />
      <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-12">
        Soluções ideais de iluminação inteligente para apartamentos modernos, coberturas e studios em Indaiatuba e região.
      </p>
